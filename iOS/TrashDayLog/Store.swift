...
final class Store: ObservableObject {
    @Published var entries: [BinEntry] = []
    ...
    init() {
        ...
        fileURL = supportDir.appendingPathComponent("trashdaylog_entries.json")
        settingsURL = supportDir.appendingPathComponent("trashdaylog_settings.json")
        load()
    }
    ...
    private func seedIfNeeded() {
        ...
        entries = [
        BinEntry(binType: "Trash", rotation: "Weekly Tuesday", nextDateISO: "2025-07-08"),
        BinEntry(binType: "Recycling", rotation: "Biweekly Wednesday", nextDateISO: "2025-07-09")
        ]
        save()
    }
